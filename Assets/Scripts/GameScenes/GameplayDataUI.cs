...
public class GameplayDataUI : NetworkBehaviour {
  ...
  void UpdateSkipCharges() {
    if (prevCharges == InputManager.skipCharges) return;
    skipCharges.text = InputManager.skipCharges.ToString();
    prevCharges = InputManager.skipCharges;
  }
