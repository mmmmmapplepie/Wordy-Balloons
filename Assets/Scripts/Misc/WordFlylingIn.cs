...
public class WordFlylingIn : MonoBehaviour {
  ...
  void PlaySound() {
    AudioPlayer.PlayOneShot_Static(whooshSFX, VolumeControl.GetEffectVol(), Random.Range(0.95f, 1.1f));
  }
  void PlaySplashSound() {
    AudioPlayer.PlayOneShot_Static(splashSFX, VolumeControl.GetEffectVol() * 0.7f, Random.Range(0.9f, 1.2f));
  }
